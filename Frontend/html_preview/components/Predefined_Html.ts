export const predefinedHtml = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
export const predefinedCss = `body {
...
export const predefinedJs = `document.addEventListener('DOMContentLoaded', function() {
  ...
  dynamicContent.innerHTML = '<p style="margin-top: 20px; padding: 10px; background-color: #e7f3ff; border-radius: 5px;">This content was added dynamically with JavaScript!</p>';
